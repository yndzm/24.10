...
# quickstart 
git_sparse_clone master https://github.com/yndzm/openwrt-X luci-app-adguardhome adguardhome luci-lib-taskd luci-lib-xterm taskd quickstart luci-app-quickstart
