...
# quickstart 
git_sparse_clone master https://github.com/yndzm/openwrt-X luci-app-adguardhome adguardhome luci-app-store luci-lib-xterm luci-lib-taskd taskd quickstart luci-app-quickstart
