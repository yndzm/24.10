...
# quickstart 
git_sparse_clone master https://github.com/kenzok8/openwrt-packages adguardhome luci-app-adguardhome luci-lib-taskd luci-lib-xterm taskd quickstart luci-app-quickstart
